...
ActiveRecord::Schema.define(version: 20170915223652) do
  ...
  create_table "samurai_tasks_tasks", force: :cascade do |t|
    ...
    t.text "content"
    t.bigint "samurai_user_id"
    t.bigint "samurai_contacts_contacts_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["samurai_contacts_contacts_id"], name: "index_samurai_tasks_tasks_on_samurai_contacts_contacts_id"
  ...
  add_foreign_key "samurai_tasks_tasks", "samurai_contacts_contacts", column: "samurai_contacts_contacts_id"
